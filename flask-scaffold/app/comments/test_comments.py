...
add_data = """{
  "data": {
    ...
    {"author": "test string", "body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "author_url": "http://techarena51.com", "created_on": "2015-06-26", "approved": "true"}
         ,
...
update_data = """{
  "data": {
    "attributes":
        ...
        {"author": "test string", "body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "author_url": "http://techarena51.com", "created_on": "2015-06-26", "approved": "false"},
    "type": "comments"
  }
